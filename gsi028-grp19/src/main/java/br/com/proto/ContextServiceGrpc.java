...
/**
 */
@javax.annotation.Generated( value = "by gRPC proto compiler (version 1.7.0)", comments = "Source: ContextProto.proto" )
public final class ContextServiceGrpc {
	...
	public static final io.grpc.MethodDescriptor< br.com.proto.ContextProto.ContextRequest, br.com.proto.ContextProto.ContextResponse > METHOD_INSERT = io.grpc.MethodDescriptor.< br.com.proto.ContextProto.ContextRequest, br.com.proto.ContextProto.ContextResponse > newBuilder()
		.setType( io.grpc.MethodDescriptor.MethodType.UNARY )
		.setFullMethodName( generateFullMethodName( "br.com.proto.ContextService", "insert" ) )
		.setRequestMarshaller(
			io.grpc.protobuf.ProtoUtils.marshaller( br.com.proto.ContextProto.ContextRequest.getDefaultInstance() ) )
		.setResponseMarshaller(
			io.grpc.protobuf.ProtoUtils.marshaller( br.com.proto.ContextProto.ContextResponse.getDefaultInstance() ) )
		.setSchemaDescriptor( new ContextServiceMethodDescriptorSupplier( "insert" ) ).build();

	@io.grpc.ExperimentalApi( "https://github.com/grpc/grpc-java/issues/1901" )
	public static final io.grpc.MethodDescriptor< br.com.proto.ContextProto.ContextRequest, br.com.proto.ContextProto.ContextResponse > METHOD_UPDATE = io.grpc.MethodDescriptor.< br.com.proto.ContextProto.ContextRequest, br.com.proto.ContextProto.ContextResponse > newBuilder()
		.setType( io.grpc.MethodDescriptor.MethodType.UNARY )
		.setFullMethodName( generateFullMethodName( "br.com.proto.ContextService", "update" ) )
		.setRequestMarshaller(
			io.grpc.protobuf.ProtoUtils.marshaller( br.com.proto.ContextProto.ContextRequest.getDefaultInstance() ) )
		.setResponseMarshaller(
			io.grpc.protobuf.ProtoUtils.marshaller( br.com.proto.ContextProto.ContextResponse.getDefaultInstance() ) )
		.setSchemaDescriptor( new ContextServiceMethodDescriptorSupplier( "update" ) ).build();

	@io.grpc.ExperimentalApi( "https://github.com/grpc/grpc-java/issues/1901" )
	public static final io.grpc.MethodDescriptor< br.com.proto.ContextProto.ContextRequest, br.com.proto.ContextProto.ContextResponse > METHOD_DELETE = io.grpc.MethodDescriptor.< br.com.proto.ContextProto.ContextRequest, br.com.proto.ContextProto.ContextResponse > newBuilder()
		.setType( io.grpc.MethodDescriptor.MethodType.UNARY )
		.setFullMethodName( generateFullMethodName( "br.com.proto.ContextService", "delete" ) )
		.setRequestMarshaller(
			io.grpc.protobuf.ProtoUtils.marshaller( br.com.proto.ContextProto.ContextRequest.getDefaultInstance() ) )
		.setResponseMarshaller(
			io.grpc.protobuf.ProtoUtils.marshaller( br.com.proto.ContextProto.ContextResponse.getDefaultInstance() ) )
		.setSchemaDescriptor( new ContextServiceMethodDescriptorSupplier( "delete" ) ).build();

	@io.grpc.ExperimentalApi( "https://github.com/grpc/grpc-java/issues/1901" )
	public static final io.grpc.MethodDescriptor< br.com.proto.ContextProto.ContextRequest, br.com.proto.ContextProto.ContextResponse > METHOD_FIND = io.grpc.MethodDescriptor.< br.com.proto.ContextProto.ContextRequest, br.com.proto.ContextProto.ContextResponse > newBuilder()
		.setType( io.grpc.MethodDescriptor.MethodType.UNARY )
		.setFullMethodName( generateFullMethodName( "br.com.proto.ContextService", "find" ) )
		.setRequestMarshaller(
			io.grpc.protobuf.ProtoUtils.marshaller( br.com.proto.ContextProto.ContextRequest.getDefaultInstance() ) )
		.setResponseMarshaller(
			io.grpc.protobuf.ProtoUtils.marshaller( br.com.proto.ContextProto.ContextResponse.getDefaultInstance() ) )
		.setSchemaDescriptor( new ContextServiceMethodDescriptorSupplier( "find" ) ).build();
		...
		public final io.grpc.ServerServiceDefinition bindService() {
			return io.grpc.ServerServiceDefinition.builder( getServiceDescriptor() )
				.addMethod(
					METHOD_INSERT,
					asyncUnaryCall(
						new MethodHandlers< br.com.proto.ContextProto.ContextRequest, br.com.proto.ContextProto.ContextResponse >(
	...
	public static final class ContextServiceStub extends io.grpc.stub.AbstractStub< ContextServiceStub > {
		...
		public void insert(
			br.com.proto.ContextProto.ContextRequest request,
			io.grpc.stub.StreamObserver< br.com.proto.ContextProto.ContextResponse > responseObserver ) {
			asyncUnaryCall( getChannel().newCall( METHOD_INSERT, getCallOptions() ), request, responseObserver );
		}
		...
		public void find(
			br.com.proto.ContextProto.ContextRequest request,
			io.grpc.stub.StreamObserver< br.com.proto.ContextProto.ContextResponse > responseObserver ) {
			asyncUnaryCall( getChannel().newCall( METHOD_FIND, getCallOptions() ), request, responseObserver );
		}
	}
	...
	public static final class ContextServiceBlockingStub
		extends io.grpc.stub.AbstractStub< ContextServiceBlockingStub > {
		...
		public br.com.proto.ContextProto.ContextResponse insert( br.com.proto.ContextProto.ContextRequest request ) {
			return blockingUnaryCall( getChannel(), METHOD_INSERT, getCallOptions(), request );
		}
		...
		public br.com.proto.ContextProto.ContextResponse find( br.com.proto.ContextProto.ContextRequest request ) {
			return blockingUnaryCall( getChannel(), METHOD_FIND, getCallOptions(), request );
		}
	}
	...
	public static final class ContextServiceFutureStub extends io.grpc.stub.AbstractStub< ContextServiceFutureStub > {
		...
		/**
		 */
		public com.google.common.util.concurrent.ListenableFuture< br.com.proto.ContextProto.ContextResponse >
			insert( br.com.proto.ContextProto.ContextRequest request ) {
			return futureUnaryCall( getChannel().newCall( METHOD_INSERT, getCallOptions() ), request );
		}

		/**
		 */
		public com.google.common.util.concurrent.ListenableFuture< br.com.proto.ContextProto.ContextResponse >
			update( br.com.proto.ContextProto.ContextRequest request ) {
		 ...
		 */
		public com.google.common.util.concurrent.ListenableFuture< br.com.proto.ContextProto.ContextResponse >
			delete( br.com.proto.ContextProto.ContextRequest request ) {
		 ...
		 */
		public com.google.common.util.concurrent.ListenableFuture< br.com.proto.ContextProto.ContextResponse >
			find( br.com.proto.ContextProto.ContextRequest request ) {
			return futureUnaryCall( getChannel().newCall( METHOD_FIND, getCallOptions() ), request );
		}
	}
	...
	private static final class ContextServiceMethodDescriptorSupplier extends ContextServiceBaseDescriptorSupplier
			...
			synchronized ( ContextServiceGrpc.class ) {
				...
				if ( result == null ) {
					serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder( SERVICE_NAME )
						.setSchemaDescriptor( new ContextServiceFileDescriptorSupplier() ).addMethod( METHOD_INSERT )
						.addMethod( METHOD_UPDATE ).addMethod( METHOD_DELETE ).addMethod( METHOD_FIND ).build();
				}
			}
		}
		return result;
